...
I am the founder of **TorchFun.AI**, driven by the belief that AI should create happiness and well-being for humanity. I am also a Ph.D. student at [HKUST-GZ](https://www.hkust-gz.edu.cn/), supervised by [Prof. Harry Shum](https://ias.hkust.edu.hk/people/ias-members/alumni/prof-harry-heung-yeung-shum) and [Prof. Lionel Ni](https://facultyprofiles.hkust-gz.edu.cn/faculty-personal-page/NI-LionelMing-Shuan/ni), working on **autoregressive visual generation** and **interactive world models**.

My journey started with NLP at **Tencent AI Lab**, then shifted to visual generation at **Xiaobing**, where I built one-shot talking head systems (ICCV 2023). At **StepFun**, I worked on large-scale visual generation — contributing to the 30B-parameter [Step-Video-T2V](https://github.com/stepfun-ai/Step-Video-T2V) <span style="display: inline-block; background: linear-gradient(135deg, #fef3c7, #fde68a); padding: 1px 7px; border-radius: 10px; font-size: 12px; font-weight: 600; color: #92400e; vertical-align: middle;"><i class="fas fa-star" style="font-size: 11px;"></i> 3k+</span>, pioneering **frame-level autoregressive** video generation ([MAGI](https://arxiv.org/abs/2501.12389), CVPR 2025), and ultimately building [NextStep-1](https://github.com/stepfun-ai/NextStep-1) — the first **autoregressive** image model with continuous tokens that matches diffusion quality at scale (ICLR 2026 Oral) <span style="display: inline-block; background: linear-gradient(135deg, #fef3c7, #fde68a); padding: 1px 7px; border-radius: 10px; font-size: 12px; font-weight: 600; color: #92400e; vertical-align: middle;"><i class="fas fa-star" style="font-size: 11px;"></i> 600+</span>.
...
<div class="row" style="margin-bottom: 16px;">
    <div class="column" style="display: inline-block; vertical-align: top; width: 25%;">
        <video autoplay loop muted playsinline style="width: 100%; border-radius: 4px;">
            <source src="/assets/images/publications/step-t2v.mp4" type="video/mp4">
        </video>
    </div>
    <div class="column" style="display: inline-block; vertical-align: top; width: 70%; margin-left: 3%">
...
[Dr. Chen Dong](http://ieeexplore.ieee.org/author/38231747500),
[Dr. Shuangzhi Wu](https://scholar.google.com/citations?user=68mtRggAAAAJ&hl=en),
[Dr. Zhaopeng Tu](https://tuzhaopeng.github.io/),
[Dr. Baoyuan Wang](https://sites.google.com/site/zjuwby/),
[Dr. Duomin Wang](https://dorniwang.github.io/),
[Dr. Yu Deng](https://yudeng.github.io/),
[Dr. Quan Sun](https://github.com/Quan-Sun),
[Dr. Zheng Ge](https://scholar.google.com/citations?user=hJ-VrrIAAAAJ&hl=zh-CN),
[Dr. Nan Duan](https://nanduan.github.io/), and
[Dr. Xiangyu Zhang](https://scholar.google.com/citations?user=yuB-cfoAAAAJ&hl=zh-CN).

## Activities

**Early Bird @ HKUST-GZ** — Founder and organizer of a student community promoting a healthy and disciplined lifestyle for academic excellence.
